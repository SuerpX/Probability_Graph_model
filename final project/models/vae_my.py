...
class VAE_DQN(nn.Module):
    def __init__(self):
        ...
        self.encoder_l4 = nn.Sequential(
            ...
            nn.ReLU())
        '''
        self.fc_mu = nn.Linear(100, self.latent_dim)
        self.fc_sigma = nn.Linear(100, self.latent_dim)
        ...
        self.decoder_l3 = nn.Sequential(
            torch.nn.Linear(200, self.input_dim))
        #self.m1 = nn.MaxPool2d(3, stride=2)
        '''
        self.decoder_l3 = nn.Sequential(
    ...
    def decode(self, z):
        ...
        h4 = self.decoder_l2(h3)
        return torch.sigmoid(self.decoder_l3(h4))
